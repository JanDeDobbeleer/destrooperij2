...
const translations = {
  ...
  artTitle: "Art",
  artText: "Les jams de graffiti et les performances de peinture en direct forment un fil conducteur artistique. Les artistes locaux disposent d’une plateforme pour montrer leur créativité, et les jeunes sont encouragés à expérimenter. De STrooperij inspire avec des couleurs et de l’expression.",
  musicTitle: "Musique",
  musicText: "Des beats, de la musique live et des DJ sets donnent vie à chaque événement. Lors de la Silent Disco et d'autres événements, de jeunes talents émergents montent également sur scène. De STrooperij croit au pouvoir de la musique pour rassembler les gens.",
